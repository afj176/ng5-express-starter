System.register(["rtts_assert/rtts_assert", "angular2/test_lib", "angular2/src/facade/collection", "angular2/src/dom/dom_adapter", "angular2/src/facade/lang", "angular2/src/render/dom/compiler/compile_pipeline", "angular2/src/render/dom/compiler/compile_element", "angular2/src/render/dom/compiler/compile_step", "angular2/src/render/dom/compiler/compile_control", "angular2/src/render/dom/view/proto_view_builder"], function($__export) {
  "use strict";
  var assert,
      describe,
      beforeEach,
  ...
  return {
    ...
    execute: function() {
      ...
      IgnoreCurrentElementStep = (function($__super) {
        ...
        return ($traceurRuntime.createClass)(IgnoreCurrentElementStep, {process: function(parent, current, control) {
            assert.argumentTypes(parent, CompileElement, current, CompileElement, control, CompileControl);
            var attributeMap = DOM.attributeMap(current.element);
...
//# sourceMappingURL=pipeline_spec.es6.map
