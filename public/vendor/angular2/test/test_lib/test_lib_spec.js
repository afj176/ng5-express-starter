  ...
  function main() {
    describe('test_lib', (function() {
      ...
      describe("spy objects", (function() {
        ...
        it('should create spys for all methods', (function() {
          expect((function() {
            return spyObj.someFunc();
          })).not.toThrow();
        }));
  ...
  return {
    ...
    execute: function() {
      TestObj = (function() {
        ...
        return ($traceurRuntime.createClass)(TestObj, {someFunc: function() {
            return assert.returnType((-1), assert.type.number);
          }}, {});
      }());
      SpyTestObj = (function($__super) {
        var SpyTestObj = function SpyTestObj() {
          $traceurRuntime.superConstructor(SpyTestObj).call(this, TestObj);
        };
...
//# sourceMappingURL=test_lib_spec.es6.map
