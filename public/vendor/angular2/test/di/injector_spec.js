System.register(["rtts_assert/rtts_assert", "angular2/src/facade/lang", "angular2/test_lib", "angular2/di"], function($__export) {
  "use strict";
  var assert,
      isBlank,
      BaseException,
  ...
  function main() {
    describe('injector', function() {
      ...
      it('should throw when no type and not @Inject', function() {
        expect((function() {
          return Injector.resolveAndCreate([NoAnnotations]);
        })).toThrowError('Cannot resolve all parameters for NoAnnotations. ' + 'Make sure they all have valid type or annotations.');
      });
      ...
      it('should support overriding factory dependencies', function() {
        var injector = Injector.resolveAndCreate([Engine, bind(Car).toFactory((function(e) {
          return new SportsCar(e);
        }), [Engine])]);
        var car = injector.get(Car);
        expect(car).toBeAnInstanceOf(SportsCar);
      ...
      it('should throw when given invalid bindings', function() {
        expect((function() {
          return Injector.resolveAndCreate(["blah"]);
        })).toThrowError('Invalid binding blah');
        expect((function() {
          return Injector.resolveAndCreate([bind("blah")]);
        })).toThrowError('Invalid binding blah');
      });
      ...
      it('should instantiate an object after a failed attempt', function() {
        var isBroken = true;
        var injector = Injector.resolveAndCreate([Car, bind(Engine).toFactory((function() {
...
//# sourceMappingURL=injector_spec.es6.map
